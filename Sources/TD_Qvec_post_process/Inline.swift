...
@inline(__always) func twoD_colrow( _ col: tNi, _ row: tNi, _ height: tNi) -> tNi
{
    return col * height + row;
    
}

@inline(__always) func twoD_colrow_len( _ col: tNi, _ row: tNi, _ height: tNi, _ len: tNi) -> tNi {
