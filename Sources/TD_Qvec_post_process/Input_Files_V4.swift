...
extension tDisk_grid_Q3_V4 : DefaultValuable {
    ...
    static func defaultValue_InvalidAcess() -> tDisk_grid_Q3_V4 {
        return defaultValue()
    }
}
extension tDisk_colrow_Q3_V4 : DefaultValuable {
    ...
    static func defaultValue_InvalidAcess() -> tDisk_colrow_Q3_V4 {
        return defaultValue()
    }
}
extension tDisk_grid_colrow_Q3_V4 : DefaultValuable {
    ...
    static func defaultValue_InvalidAcess() -> tDisk_grid_colrow_Q3_V4 {
        return defaultValue()
    }
}
...
extension tDisk_grid_colrow_Q4_V4 : DefaultValuable {
    ...
    static func defaultValue_InvalidAcess() -> tDisk_grid_colrow_Q4_V4 {
        return defaultValue()
    }
}
extension tDisk_colrow_Q4_V4 : DefaultValuable {
    ...
    static func defaultValue_InvalidAcess() -> tDisk_colrow_Q4_V4 {
        return defaultValue()
    }
}
extension tDisk_grid_Q4_V4 : DefaultValuable {
    ...
    static func defaultValue_InvalidAcess() -> tDisk_grid_Q4_V4 {
        return defaultValue()
    }
}
...
extension tDisk_grid_Q19_V4 : DefaultValuable {
    ...
    static func defaultValue_InvalidAcess() -> tDisk_grid_Q19_V4 {
        return defaultValue()
    }
}
extension tDisk_colrow_Q19_V4 : DefaultValuable {
    ...
    static func defaultValue_InvalidAcess() -> tDisk_colrow_Q19_V4 {
        return defaultValue()
    }
}
extension tDisk_grid_colrow_Q19_V4 : DefaultValuable {
    ...
    static func defaultValue_InvalidAcess() -> tDisk_grid_colrow_Q19_V4 {
        return defaultValue()
    }
}
...
extension tDisk_grid_Q27_V4 : DefaultValuable {
    ...
    static func defaultValue_InvalidAcess() -> tDisk_grid_Q27_V4 {
        return defaultValue()
    }
}
extension tDisk_colrow_Q27_V4 : DefaultValuable {
    ...
    static func defaultValue_InvalidAcess() -> tDisk_colrow_Q27_V4 {
        return defaultValue()
    }
}
extension tDisk_grid_colrow_Q27_V4 : DefaultValuable {
    ...
    static func defaultValue_InvalidAcess() -> tDisk_grid_colrow_Q27_V4 {
        return defaultValue()
    }
}
...
class Input_FILES_V4 {
    ...
    private var Disk_grid_Q3: Matrix1D<tDisk_grid_Q3_V4> = Matrix1D()
    private var Disk_colrow_Q3: Matrix1D<tDisk_colrow_Q3_V4> = Matrix1D()
    private var Disk_grid_colrow_Q3: Matrix1D<tDisk_grid_colrow_Q3_V4> = Matrix1D()
    
    private var Disk_grid_Q4: Matrix1D<tDisk_grid_Q4_V4> = Matrix1D()
    private var Disk_colrow_Q4: Matrix1D<tDisk_colrow_Q4_V4> = Matrix1D()
    private var Disk_grid_colrow_Q4: Matrix1D<tDisk_grid_colrow_Q4_V4> = Matrix1D()
    
    private var Disk_grid_Q19: Matrix1D<tDisk_grid_Q19_V4> = Matrix1D()
    private var Disk_colrow_Q19: Matrix1D<tDisk_colrow_Q19_V4> = Matrix1D()
    private var Disk_grid_colrow_Q19: Matrix1D<tDisk_grid_colrow_Q19_V4> = Matrix1D()
    ...
    func get_start(_ dir_root: String, _ name: String, _ plot_type: String, _ Q_length: Int, _ step: tStep) -> String {
        return dir_root + "/" + name + "." + plot_type + ".V_4.Q_" + to_string(Q_length) + ".step_" + format_step(step);
    }
    ...
    func get_XY_plane_dir(_ step: tStep, _ at_k: tNi, _ Q_length: Int, _ name: String="plot", _ dir_root: String=".") -> String {
        ...
        return get_start(dir_root, name, "XYplane", Q_length, step) + ".cut_" + to_string(at_k);
    }
    
    //Formally Axis
    func get_XZ_plane_dir( _ step: tStep, _ at_j: tNi, _ Q_length: Int, _ name: String="plot", _ dir_root: String=".") -> String{
        
        return get_start(dir_root, name, "XZplane", Q_length, step) + ".cut_" + to_string(at_j);
    }
    
    //Formally Slice
    func get_YZ_plane_dir( _ step: tStep, _ at_i: tNi, _ Q_length: Int, _ name: String="plot", _ dir_root: String=".") -> String{
        
        return get_start(dir_root, name, "YZplane", Q_length, step) + ".cut_" + to_string(at_i);
    }
    ...
    func get_capture_at_blade_angle_dir( _ step: tStep, _ angle: Int, _ blade_id: Int, _ Q_length: Int, _ name: String="plot_", _ dir_root: String=".") -> String{
        ...
        return get_start(dir_root, name, "rotational_capture", Q_length, step) + ".angle_" + to_string(angle) + ".blade_id_" + to_string(blade_id);
    }
    
    
    func get_axis_when_blade_angle_dir( _ step: tStep, _ angle: Int, _ Q_length: Int, _ name: String="plot", _ dir_root: String=".") -> String{
        
        return get_start(dir_root, name, "YZplane", Q_length, step) + ".angle_" + to_string(angle);
    }
    ...
    func get_dir_delta( _ delta: Int, _  load_dir: inout String)  -> String{
        //    using namespace std;
    ...
    func plot_type_in_dir( _ type: String, _ load_dir:  String) -> Bool {
        //    using namespace std;
    ...
    func get_plot_type_from_directory( _ load_dir:inout String)  -> String{
    ...
    func load_plane( _ num_layers: Int,  _ load_dir: inout String, _ Q_plane: inout Matrix3D_array<tQvec>, _ F_plane: inout Matrix3D_array<tForce>, _ pp: inout PP_Dims)
    {
            ...
            for u in 0..<q.bin_file_size_in_structs {
                ...
                if (is_F){
                    ...
                    if (q.struct_name == "tDisk_colrow_Q3_V4"){
                        ...
                        plane[ col, row, 0] = Disk_colrow_Q3[Int(u)].s[0];
                        plane[ col, row, 1] = Disk_colrow_Q3[Int(u)].s[1];
                        plane[ col, row, 2] = Disk_colrow_Q3[Int(u)].s[2];
                        ...
                        plane[ col, row, 0] = Disk_grid_colrow_Q3[Int(u)].s[0];
                        plane[ col, row, 1] = Disk_grid_colrow_Q3[Int(u)].s[1];
                        plane[ col, row, 2] = Disk_grid_colrow_Q3[Int(u)].s[2];
                    ...
                    if (q.struct_name == "tDisk_colrow_Q4_V4"){
                        ...
                        plane[ col, row, 0] = Disk_colrow_Q4[Int(u)].s[0];
                        plane[ col, row, 1] = Disk_colrow_Q4[Int(u)].s[1];
                        plane[ col, row, 2] = Disk_colrow_Q4[Int(u)].s[2];
                        plane[ col, row, 3] = Disk_colrow_Q4[Int(u)].s[3];
                        ...
                        plane[ col, row, 0] = Disk_grid_colrow_Q4[Int(u)].s[0];
                        plane[ col, row, 1] = Disk_grid_colrow_Q4[Int(u)].s[1];
                        plane[ col, row, 2] = Disk_grid_colrow_Q4[Int(u)].s[2];
                        plane[ col, row, 3] = Disk_grid_colrow_Q4[Int(u)].s[3];
...
//    not used
//    func load_angle( _ layers: Int, _ load_dir:inout String, _ plane: inout [tQvec], _ pp: inout PP_Dims)
//    {}
