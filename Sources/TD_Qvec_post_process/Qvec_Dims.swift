...
extension Qvec_Dims : DefaultValuable {
    ...
    static func defaultValue_InvalidAcess() -> Qvec_Dims {
        return defaultValue()
    }
}
...
class Handle_Qvec_Dims: Base_Dims<Qvec_Dims>{
    internal override func get_name()-> String{return "Qvec_Dims";}
    ...
    func set_file_content( _ struct_name: String, _ bin_file_size_in_structs: ULongInt,
         ...
         Q_data_type: String, Q_output_length: Int32)
    {
